...
{
    public interface IMappableNone<out T, TMappingDestination>
    {
        /// <summary>
        ...
        IFilteredMappableContent<T, TMappingDestination, IMappableNone<T, TMappingDestination>> When(
        ...
        /// </summary>
        /// <returns>The filtered flow containing the following possible mapping action to perform on the optional value.</returns>
        IFilteredMappableContent<T, TMappingDestination> WhenSome();
    }
}